...
//     const [amountWon,setAmountWon]=useState<number|string>(0);
//     const handleSpin = () => {
...
//                     setAmountWon(parseFloat(data.outcome.label));
//                 }, 3000);
//
//             } catch (err) {
